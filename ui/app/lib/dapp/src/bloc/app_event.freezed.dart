...
mixin _$IsLoggedInStatusChanged {
  ...
  /// Create a copy of IsLoggedInStatusChanged
...
/// @nodoc
mixin _$IsFirstLogInStatusChanged {
  bool get isFirstLogin => throw _privateConstructorUsedError;

  /// Create a copy of IsFirstLogInStatusChanged
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $IsFirstLogInStatusChangedCopyWith<IsFirstLogInStatusChanged> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $IsFirstLogInStatusChangedCopyWith<$Res> {
  factory $IsFirstLogInStatusChangedCopyWith(IsFirstLogInStatusChanged value,
          $Res Function(IsFirstLogInStatusChanged) then) =
      _$IsFirstLogInStatusChangedCopyWithImpl<$Res, IsFirstLogInStatusChanged>;
  @useResult
  $Res call({bool isFirstLogin});
}

/// @nodoc
class _$IsFirstLogInStatusChangedCopyWithImpl<$Res,
        $Val extends IsFirstLogInStatusChanged>
    implements $IsFirstLogInStatusChangedCopyWith<$Res> {
  _$IsFirstLogInStatusChangedCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$IsFirstLogInStatusChangedImplCopyWith<$Res>
    implements $IsFirstLogInStatusChangedCopyWith<$Res> {
  factory _$$IsFirstLogInStatusChangedImplCopyWith(
          _$IsFirstLogInStatusChangedImpl value,
          $Res Function(_$IsFirstLogInStatusChangedImpl) then) =
      __$$IsFirstLogInStatusChangedImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({bool isFirstLogin});
}
...
/// @nodoc
class __$$IsFirstLogInStatusChangedImplCopyWithImpl<$Res>
    extends _$IsFirstLogInStatusChangedCopyWithImpl<$Res,
        _$IsFirstLogInStatusChangedImpl>
    implements _$$IsFirstLogInStatusChangedImplCopyWith<$Res> {
  __$$IsFirstLogInStatusChangedImplCopyWithImpl(
      _$IsFirstLogInStatusChangedImpl _value,
      $Res Function(_$IsFirstLogInStatusChangedImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$IsFirstLogInStatusChangedImpl(
      isFirstLogin: null == isFirstLogin
          ? _value.isFirstLogin
          : isFirstLogin // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _$IsFirstLogInStatusChangedImpl implements _IsFirstLogInStatusChanged {
  const _$IsFirstLogInStatusChangedImpl({required this.isFirstLogin});
  ...
  @override
  String toString() {
    return 'IsFirstLogInStatusChanged(isFirstLogin: $isFirstLogin)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$IsFirstLogInStatusChangedImpl &&
            (identical(other.isFirstLogin, isFirstLogin) ||
                other.isFirstLogin == isFirstLogin));
  }

  @override
  int get hashCode => Object.hash(runtimeType, isFirstLogin);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$IsFirstLogInStatusChangedImplCopyWith<_$IsFirstLogInStatusChangedImpl>
      get copyWith => __$$IsFirstLogInStatusChangedImplCopyWithImpl<
          _$IsFirstLogInStatusChangedImpl>(this, _$identity);
}

abstract class _IsFirstLogInStatusChanged implements IsFirstLogInStatusChanged {
  const factory _IsFirstLogInStatusChanged({required final bool isFirstLogin}) =
      _$IsFirstLogInStatusChangedImpl;
